    ...
    const CITY_ILLUSTRATIONS = {
      Guangzhou: "./assets/fly-guangzhou.webp",
      guangzhou: "./assets/fly-guangzhou.webp",
      HongKong: "./assets/fly-hongkong.webp",
      hongkong: "./assets/fly-hongkong.webp"
    };
      ...
      return {
        ...
        destinations: list
          ...
          .map((destination, index) => ({
            ...
            flightInfo: destination.flightInfo || null,
            flavorTags: Array.isArray(destination.flavorTags) ? destination.flavorTags : [],
            displayTags: Array.isArray(destination.displayTags) ? destination.displayTags : [],
    ...
    function renderFlightShoppingNote() {
      ...
      flightShoppingNoteText.textContent = `已找到 ${summary.collected}/${summary.total} 样食材，还差 ${summary.needed} 样。`;
    ...
    function removeFlightLuggageItem(id) {
      window.AppInventory.removeLuggageItem(id);
    ...
    async function initGallery() {
      ...
      if (Array.isArray(window.APP_DATA?.destinations) && window.APP_DATA.destinations.length) {
        applyCityData({
          generatedAt: "runtime",
          source: "window.APP_DATA.destinations",
          destinations: window.APP_DATA.destinations
        });
      } else {
