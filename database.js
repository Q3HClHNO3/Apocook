(function () {
  // Unified data layer: data/ingredients.json, data/recipes.json, data/cityRoutes.json, data/flights.json.
  ...
  async function initDatabase() {
    const [ingredients, recipes, cityRoutes, flights] = await Promise.all([
